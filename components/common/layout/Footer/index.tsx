...
//     section: "Category",
//     link: [
//       { label: 'Simbar Plants & Media', path: '/product' },
//       { label: 'Simbar Care Supplies', path: '/product' },
//       { label: 'Simbar Accessories & Displays', path: '/accessories' },
//     ],
//   },
// ];
...
const footer = () => {
    return (
        <div className="bg-[#007BFF] -mt-40" id="first-section">
            <div className="mx-auto max-w-2xl pt-48 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">

                    {/* COLUMN-1 */}

                    <div className='col-span-4 col-start-5 flex flex-col items-center text-center'>
                    ...
                    <div key={product.id} className={`group relative col-span-2 ${product.section === "Category" ? "ml-auto" : ""}`}>
                        <p className="text-white text-xl font-extrabold mb-9">{product.section}</p>
                        <ul>
                        {product.link.map((item, index) => (
                            <li key={index} className="mb-5">
                            <Link href={item.path} className="text-white text-lg font-normal mb-6 space-links">
                                {item.label}
                            </Link>
                            </li>
                        ))}
            ...
            <div className="mx-auto max-w-2xl lg:max-w-7xl">
                <div className="pt-5 pb-5 px-4 sm:px-6 lg:px-4 border-solid border-t border-footer">
                    <div className="mt-4 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 xl:gap-x-8">
                        <div>
                            <h3 className='text-center md:text-start text-offwhite text-lg'>@2025 - Made By Kelompok 1</h3>
                        </div>
